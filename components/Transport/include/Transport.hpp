/******************************************************************************
 * @file    Transport.hpp
 * @brief   Abstract interface for stream-based communication transports.
 *
 * Defines the common API for establishing connections, sending, receiving,
 * and disconnecting transport implementations.
 *
